...
export function WhatsAppButton() {
  ...
  const message = "Hi! I'd like to know more about custom t-shirt printing.";
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-16 bg-[#1A1A1A] text-white text-xs font-medium px-3 py-1.5 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
        Chat with us
      </span>
    </a>
  );
